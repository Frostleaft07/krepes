...
git clone https://github.com/Frostleaft07/proprietary_vendor_realme_RMX2185R vendor/realme/RMX2185
...
gen_keys kontolkuda@gimayil.choms
m bacon -j$(nproc --all)
ota_sign
