...
MNFS=https://github.com/Frostleaft07/manifest
BR=lineage-18.1
...
git clone https://github.com/Frostleaft07/device_realme_RMX2185 -b losfe11 device/realme/RMX2185
...
git clone https://github.com/Frostleaft07/packages_apps_Settings-fe -b lineage-18.1 packages/apps/Settings
...
curl bashupload.com -T *2185*sobar*.zip
